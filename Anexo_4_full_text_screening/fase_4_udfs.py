...
############################################
# Full Text Screening User-Defined Functions
############################################
...
def create_biomarker_extraction_table():
    """Crea una tabla vacía para extraer información sobre biomarcadores"""
...
def create_study_extraction_table():
    """Crea una tabla vacía para extraer información sobre estudios"""
...
def choose_study(autor, year, df):
    """Añade un nuevo estudio a la tabla de estudios"""
...
def add_biomarker(article_id, name, biomarker_type, sample_type, technique, 
    ...
    """Añade un nuevo biomarcador a la tabla de biomarcadores"""
...
def generate_summary_tables():
    """Genera tablas resumen a partir de los datos extraídos"""
